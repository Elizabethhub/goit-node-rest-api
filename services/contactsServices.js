...
export const getContactsByFilter = (filter, query = {}) => Contact.find(filter, "-createdAt -updatedAt", query);
...
export const updateStatusByFilter = (filter, data) => Contact.findOneAndUpdate(filter, data, { new: true, runValidators: false });
